...
interface IWorkspaceTrustTransitionParticipant {
    participate(trusted: boolean): Promise<void>;
}
interface IWorkspaceTrustUriInfo {
    uri: URI;
    trusted: boolean;
}

export { IWorkspaceTrustEnablementService, IWorkspaceTrustManagementService, IWorkspaceTrustRequestService, type IWorkspaceTrustTransitionParticipant, type IWorkspaceTrustUriInfo, type WorkspaceTrustRequestButton, type WorkspaceTrustRequestOptions, WorkspaceTrustUriResponse };
