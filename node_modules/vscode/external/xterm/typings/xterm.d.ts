...
export { type FontWeight, type IBuffer, type IBufferCell, type IBufferCellPosition, type IBufferLine, type IBufferNamespace, type IBufferRange, type IDecoration, type IDecorationOptions, type IDecorationOverviewRulerOptions, type IDisposable, type IDisposableWithEvent, type IEvent, type IFunctionIdentifier, type ILink, type ILinkDecorations, type ILinkHandler, type ILinkProvider, type ILocalizableStrings, type ILogger, type IMarker, type IModes, type IParser, type ITerminalAddon, type ITerminalInitOnlyOptions, type ITerminalOptions, type ITheme, type IUnicodeHandling, type IUnicodeVersionProvider, type IWindowOptions, type IWindowsPty, type LogLevel, Terminal };
