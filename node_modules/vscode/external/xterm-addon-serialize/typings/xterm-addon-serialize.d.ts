import { ITerminalAddon, Terminal } from '../../xterm/typings/xterm.js';

/**
   * An xterm.js addon that enables serialization of terminal contents.
   */
  declare class SerializeAddon implements ITerminalAddon {
...
export { type IHTMLSerializeOptions, type ISerializeOptions, SerializeAddon };
